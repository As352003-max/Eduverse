...
import {
    UserIcon, EnvelopeIcon, LockClosedIcon, ArrowPathIcon,
    ExclamationCircleIcon, AcademicCapIcon
                ...
                >
                    ...
                    <div className="relative z-10 flex flex-col items-center">
                        ...
                        <ul className="space-y-3 text-indigo-100 text-base">
                            <li className="flex items-center"><span className="h-3 w-3 rounded-full bg-pink-400 mr-2" /> Personalized dashboard</li>
                            <li className="flex items-center"><span className="h-3 w-3 rounded-full bg-yellow-400 mr-2" /> Interactive courses & resources</li>
                            <li className="flex items-center"><span className="h-3 w-3 rounded-full bg-green-400 mr-2" /> Progress tracking & achievements</li>
                        </ul>
                    </div>
                </motion.div>
